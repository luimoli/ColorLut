...
def trilinear_interpolation(lut, input_rgb):
    ...
    c00 = c000 * (1 - indices_frac[..., 2][..., None]) + c001 * indices_frac[..., 2][..., None]
    c01 = c010 * (1 - indices_frac[..., 2][..., None]) + c011 * indices_frac[..., 2][..., None]
    c10 = c100 * (1 - indices_frac[..., 2][..., None]) + c101 * indices_frac[..., 2][..., None]
    c11 = c110 * (1 - indices_frac[..., 2][..., None]) + c111 * indices_frac[..., 2][..., None]

    c0 = c00 * (1 - indices_frac[..., 1][..., None]) + c01 * indices_frac[..., 1][..., None]
    c1 = c10 * (1 - indices_frac[..., 1][..., None]) + c11 * indices_frac[..., 1][..., None]

    c = c0 * (1 - indices_frac[..., 0][..., None]) + c1 * indices_frac[..., 0][..., None]
